...
export const markdownStyles = {
  jiangnan: { name: "江南书札", short: "书札", description: "疏朗题签 · 文气章节 · 注脚式引文", fit: "人物、产业叙事", theme: "eastern", layout: "calm", fontProfile: "classic", typography: { bodySize: 18, lineHeight: 1.9, titleScale: 1, tracking: .01 }, components: { heading: "chapter", quote: "letter", list: "ordered" } },
  editorial: { name: "编辑部手记", short: "手记", description: "强题破局 · 横线分章 · 拉引成势", fit: "评论、趋势判断", theme: "editorial", layout: "editorial", fontProfile: "classic", typography: { bodySize: 18, lineHeight: 1.82, titleScale: 1.02, tracking: .006 }, components: { heading: "rule", quote: "editorial", list: "ledger" } },
  technical: { name: "技术纪要", short: "纪要", description: "编号分层 · 参数成组 · 证据优先", fit: "标准、材料技术", theme: "industrial", layout: "balanced", fontProfile: "clear", typography: { bodySize: 17, lineHeight: 1.82, titleScale: 1, tracking: 0 }, components: { heading: "index", quote: "note", list: "ledger" } },
  essay: { name: "观点长卷", short: "长卷", description: "题跋居中 · 缓章慢读 · 引文成景", fit: "深度长文、专栏", theme: "editorial", layout: "calm", fontProfile: "literary", typography: { bodySize: 18, lineHeight: 1.94, titleScale: 1.03, tracking: .012 }, components: { heading: "centered", quote: "essay", list: "minimal" } },
  minimal: { name: "清简白页", short: "清简", description: "去饰留序 · 短段快读 · 信息直达", fit: "快讯、短评、清单", theme: "minimal", layout: "balanced", fontProfile: "clear", typography: { bodySize: 18, lineHeight: 1.82, titleScale: .98, tracking: 0 }, components: { heading: "plain", quote: "note", list: "minimal" } },
  spring: { name: "草长莺飞", short: "莺飞", description: "柳色题签 · 杏纸轻读 · 春水收章", fit: "人文随笔、品牌故事", theme: "spring", layout: "calm", fontProfile: "literary", typography: { bodySize: 18, lineHeight: 1.94, titleScale: 1, tracking: .012 }, components: { heading: "centered", quote: "letter", list: "minimal" } },
  collage: { name: "纸上辑录", short: "辑录", description: "纸签分章 · 档案引文 · 定格入场", fit: "品牌故事、人物专访", theme: "collage", layout: "calm", fontProfile: "classic", typography: { bodySize: 18, lineHeight: 1.88, titleScale: 1, tracking: .008 }, components: { heading: "chapter", quote: "editorial", list: "ordered" } },
